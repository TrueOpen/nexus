module github.com/TrueOpen/nexus/gen/trueopen
...
// The sonic v1.14.2 pulled in by the Cosmos SDK does not compile under Go 1.26; pin it to
// v1.15.0, the same as the root module.
